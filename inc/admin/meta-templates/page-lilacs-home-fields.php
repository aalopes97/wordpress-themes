        ...
        (function($){
          ...
          window.biremePickImage = function(btnSel, inputSel, previewSel){
            ...
            frame.on('select', function(){
              ...
              $(inputSel).val(att.id);
              var url = (att.sizes && att.sizes.medium_large) ? att.sizes.medium_large.url : (att.sizes && att.sizes.large ? att.sizes.large.url : att.url);
              $(previewSel).html('<img src=\"'+url+'\" alt=\"\">');
            });
            frame.open();
          };
        
          // [NOVO] Repetidor genérico: add/remove linha
          $(document).on('click','[data-repeater-add]',function(e){
            ...
            // zera o valor
            proto.find('input[type=\"text\"]').val('');
          ...
          $(document).on('click','[data-repeater-del]',function(e){
            ...
            else { row.find('input[type=\"text\"]').val(''); }
          });
        })(jQuery);
        ";
